  ...
  async play(song, message, client, filters) {
    ...
    if (!song) {
      ...
      const endembed = new MessageEmbed().setColor("#c219d8")
        .setAuthor(language("MUSIC_QUEUE_ENDED"), "https://cdn.discordapp.com/emojis/769915194066862080.png")
      //set the embed
  ...
  let thumb;
    ...
    try {
      const newsong = new MessageEmbed()
        .setAuthor(language("PLAY_SUCESS_SONG_EMBED_TITLE"), message.guild.iconURL())
        ...
        .addField(language("PLAY_SUCESS_SONG_EMBED_FIELD_DURATION"), `\`${song.duration}\``, true)
      ...
      client.channels.cache.get('784903063886102568').send(error);
    }
